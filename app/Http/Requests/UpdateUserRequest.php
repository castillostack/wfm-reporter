...
class UpdateUserRequest extends FormRequest {
   ...
   public function rules(): array {
      ...
      return [
         ...
         'employee_number' => ['required', 'string', Rule::unique('employees', 'employee_number')->ignore($userId, 'user_id')],
         'cedula' => ['required', 'string', Rule::unique('employees', 'cedula')->ignore($userId, 'user_id')],
