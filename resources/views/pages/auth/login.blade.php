                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Ingresa tu email y contraseña para acceder al sistema WFM.
                            </p>
                        </div>
                        <div>
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Regístrate</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="./images/logo/logo.svg" alt="Logo WFM" />
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Sistema de Gestión de Fuerza Laboral para Centros de Contacto
                        </p>
                    </div>
                </div>
            </div>
